...
resource "aws_subnet" "vec_prd_bst_subnet_2a" {
  ...
  tags = {
    ...
    "kubernetes.io/role/elb"                      = "1"      #public subnet은 태그로 elb
    "kubernetes.io/cluster/terraform-eks-cluster" = "shared" #cluster 이름
  }
}
...
resource "aws_subnet" "vec_prd_pri_subnet_2a" {
  ...
  tags = {
    ...
    "kubernetes.io/role/internal-elb"             = "1" #private subnet은 태그가 internal-elb
    "kubernetes.io/cluster/terraform-eks-cluster" = "shared"
  }
}
